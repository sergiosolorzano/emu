...
class Feature_Manager():
	...
	def __init__(self):
		...
		self.feature_base_instance = ft_common.Feature_Common()
		...
		'1': ft_req_raw.Feature_Request_Rawcode(self.feature_base_instance),
		'2': ft_req_loadcode.Feature_Request_Loadcode(self.feature_base_instance),
		'3': ft_req_argparse.Feature_Request_Argparse(self.feature_base_instance),
		#'4': ft_req_utest.Feature_Request_ExceptionHndl_and_Logging(),
	...
	def process_valid_response(self):
		print("***AT PROCESS VALID REPSONSE")
