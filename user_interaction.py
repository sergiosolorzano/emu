...
#NEW: import request functionality classes
import request_utest as cls_req_utest
...
def main():
    ...
    #Instantiate request functionality classes
    cls_req_utest_inst = cls_req_utest.Request_Utest()
